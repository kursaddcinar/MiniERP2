    ...
    public partial class StokTransferiForm : Form
    {
        ...
        private async void LoadComboBoxData()
        {
            try
            {
                ...
                var stockResponse = await _apiService.GetAsync<PagedResult<StockCardDto>>("api/Stock/cards?pageSize=1000");
        ...
        private async void BtnTransfer_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var response = await _apiService.PostAsync<object>("api/Stock/movements", movement);
        ...
        private bool ValidateForm()
        {
            ...
            if (cmbFromWarehouse.SelectedValue?.Equals(cmbToWarehouse.SelectedValue) == true)
            {
